...
router.route("/fichas")
    ...
    .post((req, res) => {
        ...
        db.getConnection((err, connection) =>{
            ...
            connection.query('INSERT INTO ficha(rut,fecha_nacimiento,fecha_ficha, padre_con_vida, enfermedad_padre, madre_con_vida, enfermedad_madre) VALUES (?,?,?,?,?,?,?)',
            [rut,fecha_nacimiento,fecha_ficha, padre_con_vida, enfermedad_padre, madre_con_vida, enfermedad_madre],
            (err, rows) =>{
                connection.release() // return the connection to pool
